...
export const clanErrors = {
  ...
  joinClosed: () => new ForbiddenException({ code: 'CLAN_JOIN_CLOSED', message: 'Dieser Clan nimmt keine neuen Mitglieder auf' }),
  inviteRequired: () => new ForbiddenException({ code: 'CLAN_INVITE_REQUIRED', message: 'Beitritt nur mit Einladung möglich' }),
