...
import type { AccessResponse, AuthUser, AvailabilityResponse, LoginPayload, RegisterPayload } from './auth.types'
...
export const authApi = {
  ...
  usernameAvailable: (username: string) => api.get<AvailabilityResponse>('/auth/username-available', { params: { username } }).then(r => r.data.available),
